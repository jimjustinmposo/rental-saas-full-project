  ...
  return (
    <div
      style={{
        ...
        background:
          "linear-gradient(135deg, #5b3df0 0%, #3f27a8 60%, #d946ef 130%)",
        padding: 16
      }}
    >
      {!adminUnlocked ? (
        ...
        >
          ...
          >
            Account creation is invite-only. Enter the admin password to
            continue.
          </p>
        ...
        >
          ...
          >
            You'll get your own private dashboard — your data is never shared
            with other owners.
          </p>
